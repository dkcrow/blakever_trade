#!/usr/bin/env python3
"""七星美股版 80%·15日恐慌过滤 — 基于us100_backtest规则(35池/无score阈值/直接top7)
唯一变量=恐慌过滤开关。1年+3年回测对比。
"""
...
START='2023-06-01'; END='2026-04-23'
...
def run(td_list, enable_panic):
    pf=USPortfolio(); hn=HOLDINGS; panic_idx=[]
...
for label, sd, ed in [('3年','2023-06-01','2026-04-23'),('1年','2025-04-01','2026-04-23')]:
    td_all=[d for d in trade_dates if sd<=d<=ed]
    print(f"\n{'='*100}")
    print(f"  七星美股版 80%·15日恐慌过滤 — {label} ({len(td_all)}交易日) [35池/7只/无score阈值]")
    print('='*100)
