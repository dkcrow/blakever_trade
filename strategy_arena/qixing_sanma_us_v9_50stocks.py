...
# -*- coding: utf-8 -*-
"""
三马七星策略 - 美股个股版本 V9（50只股票池 + ATR 2倍止损）
=============================================================
核心改进：
1. 股票池扩大到50只，覆盖低/中/高波动率
2. 使用V7最优参数：ATR 2倍动态止损
3. 保持Top2持仓
"""
...
# 50只股票：低波动15只 + 中波动20只 + 高波动15只
STOCK_LIST = {
    # 低波动 (avg 19.7%)
    'KO': '可口可乐', 'JNJ': '强生', 'PG': '宝洁', 'RSG': '共和废品处理',
    'BRK-B': '伯克希尔-B', 'WM': '废物管理', 'PEP': '百事', 'CL': '高露洁',
    'MMC': '威达信', 'VZ': '威瑞森', 'MCD': '麦当劳', 'DUK': '杜克能源',
    'CMS': 'CMS能源', 'AEP': '美国电力', 'KMB': '金佰利',
    # 中波动 (avg 32.6%)
    'IBM': 'IBM', 'ORLY': '奥莱利', 'MA': '万事达', 'EXR': 'Extra Space存储',
    'CMI': '康明斯', 'CHRW': '罗宾逊全球物流', 'OMC': '宏盟集团', 'IFF': '国际香料',
    'FOX': '福克斯', 'GLW': '康宁', 'ORCL': '甲骨文', 'WBA': '沃尔格林',
    'NEM': '纽曼矿业', 'RF': 'Regions金融', 'VTRS': '晖致', 'QCOM': '高通',
    'SIRI': '天狼星XM', 'CFG': '公民金融', 'PANW': 'Palo Alto网络', 'PYPL': 'PayPal',
    # 高波动 (avg 76.4%)
    'VRT': 'Vertiv', 'TTD': 'The Trade Desk', 'PDD': '拼多多', 'PLTR': 'Palantir',
    'APT': 'Alpha Pro Tech', 'MRNA': 'Moderna', 'ARM': 'ARM控股', 'MSTR': 'MicroStrategy',
    'ENPH': 'Enphase能源', 'APP': 'AppLovin', 'INSM': 'Insmed', 'PTON': 'Peloton',
    'COIN': 'Coinbase', 'DD': '杜邦', 'CVNA': 'Carvana',
}
...
class QixingSanmaV9(bt.Strategy):
    params = (
...
def run_backtest(start_date='2016-05-19', end_date='2026-05-18'):
    ...
    cerebro.addstrategy(QixingSanmaV9)
