...
'''
    ...
    # 完整HTML
    # DEBUG: Check trades_html
    print(f'[DEBUG] trades_html length: {len(trades_html)}')
    if trades_html:
        print(f'[DEBUG] trades_html preview: {trades_html[:200]}')
