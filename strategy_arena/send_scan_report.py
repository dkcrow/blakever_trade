...
# ==================== 美股回测数据 ====================
us_backtest_data = [
    {"name": "Supertrend ATR自适应趋势跟踪", "type": "趋势跟踪", "fp": "4c1073f1", "score": 0, "ret": 7.08, "sharpe": 0.42, "dd": 39.92, "pf": 10.0, "wr": 0, "trades": 0.3, "pass": False, "reason": "回撤>25%; 年化<15%; 夏普<0.5"},
    {"name": "Donchian通道突破(海龟交易法)", "type": "趋势跟踪", "fp": "53092435", "score": 0, "ret": 1.13, "sharpe": 0.11, "dd": 28.55, "pf": 1.48, "wr": 41.4, "trades": 4.0, "pass": False, "reason": "回撤>25%; 年化<15%; 夏普<0.5"},
    {"name": "Dual Momentum双动量策略", "type": "趋势跟踪", "fp": "57856069", "score": 19.93, "ret": 1.18, "sharpe": 0.01, "dd": 21.82, "pf": 1.35, "wr": 37.4, "trades": 6.0, "pass": False, "reason": "年化<15%; 夏普<0.5"},
    {"name": "MACD+Supertrend双重过滤", "type": "趋势跟踪", "fp": "b770f27a", "score": 0, "ret": 1.23, "sharpe": 0.18, "dd": 33.06, "pf": 1.16, "wr": 39.4, "trades": 9.4, "pass": False, "reason": "回撤>25%; 年化<15%; 夏普<0.5"},
    {"name": "EMA交叉+ADX趋势强度过滤", "type": "趋势跟踪", "fp": "1a31ebc7", "score": 0, "ret": 4.8, "sharpe": 0.33, "dd": 36.94, "pf": 1.66, "wr": 43.8, "trades": 6.0, "pass": False, "reason": "回撤>25%; 年化<15%; 夏普<0.5"},
    {"name": "高股息轮动策略", "type": "趋势跟踪", "fp": "6be4ae8d", "score": 0, "ret": -2.57, "sharpe": -0.2, "dd": 32.29, "pf": 0.91, "wr": 44.3, "trades": 10.5, "pass": False, "reason": "回撤>25%; 年化<15%; 夏普<0.5"},
    {"name": "Keltner通道突破策略", "type": "趋势跟踪", "fp": "7632ef57", "score": 0, "ret": 2.16, "sharpe": 0.13, "dd": 32.36, "pf": 4.07, "wr": 40.0, "trades": 1.8, "pass": False, "reason": "回撤>25%; 年化<15%; 夏普<0.5"},
    ...
    {"name": "Triple EMA三层均线策略", "type": "趋势跟踪", "fp": "b5f7b315", "score": 0, "ret": 0.11, "sharpe": 0.0, "dd": 32.24, "pf": 1.38, "wr": 34.2, "trades": 3.7, "pass": False, "reason": "回撤>25%; 年化<15%; 夏普<0.5"},
    {"name": "VWAP趋势跟踪策略", "type": "趋势跟踪", "fp": "5046ba27", "score": 0, "ret": -2.98, "sharpe": -0.1, "dd": 36.88, "pf": 0.94, "wr": 35.3, "trades": 14.2, "pass": False, "reason": "回撤>25%; 年化<15%; 夏普<0.5"},
    {"name": "RSI趋势确认策略", "type": "趋势跟踪", "fp": "239cb63e", "score": 0, "ret": -2.07, "sharpe": -0.09, "dd": 36.46, "pf": 0.98, "wr": 33.0, "trades": 10.9, "pass": False, "reason": "回撤>25%; 年化<15%; 夏普<0.5"},
]

# ==================== 港股回测数据 ====================
hk_backtest_data = [
    {"name": "Supertrend ATR自适应趋势跟踪", "type": "趋势跟踪", "fp": "4c1073f1", "score": 0, "ret": 9.13, "sharpe": 0.19, "dd": 61.03, "pf": 10.0, "wr": 0, "trades": 0.3, "pass": False, "reason": "回撤>25%; 年化<15%; 夏普<0.5"},
    {"name": "Donchian通道突破(海龟交易法)", "type": "趋势跟踪", "fp": "53092435", "score": 0, "ret": 0.62, "sharpe": 0.0, "dd": 43.15, "pf": 1.04, "wr": 34.5, "trades": 3.6, "pass": False, "reason": "回撤>25%; 年化<15%; 夏普<0.5"},
    {"name": "Dual Momentum双动量策略", "type": "趋势跟踪", "fp": "57856069", "score": 0, "ret": -4.16, "sharpe": -0.32, "dd": 30.93, "pf": 1.04, "wr": 31.1, "trades": 4.7, "pass": False, "reason": "回撤>25%; 年化<15%; 夏普<0.5"},
    {"name": "MACD+Supertrend双重过滤", "type": "趋势跟踪", "fp": "b770f27a", "score": 0, "ret": -0.97, "sharpe": 0.07, "dd": 50.81, "pf": 1.01, "wr": 35.2, "trades": 9.5, "pass": False, "reason": "回撤>25%; 年化<15%; 夏普<0.5"},
    {"name": "EMA交叉+ADX趋势强度过滤", "type": "趋势跟踪", "fp": "1a31ebc7", "score": 0, "ret": 12.58, "sharpe": 0.22, "dd": 54.56, "pf": 1.24, "wr": 39.0, "trades": 6.7, "pass": False, "reason": "回撤>25%; 年化<15%; 夏普<0.5"},
    {"name": "布林带均值回归策略", "type": "趋势跟踪", "fp": "743c7e87", "score": 0, "ret": 1.37, "sharpe": 0.24, "dd": 37.92, "pf": 2.81, "wr": 60.0, "trades": 4.6, "pass": False, "reason": "回撤>25%; 年化<15%; 夏普<0.5"},
    {"name": "高股息轮动策略", "type": "趋势跟踪", "fp": "6be4ae8d", "score": 0, "ret": -7.56, "sharpe": -0.43, "dd": 43.46, "pf": 0.77, "wr": 37.4, "trades": 9.0, "pass": False, "reason": "回撤>25%; 年化<15%; 夏普<0.5"},
    {"name": "Keltner通道突破策略", "type": "趋势跟踪", "fp": "7632ef57", "score": 0, "ret": -1.0, "sharpe": -0.06, "dd": 48.6, "pf": 2.23, "wr": 28.8, "trades": 1.6, "pass": False, "reason": "回撤>25%; 年化<15%; 夏普<0.5"},
    {"name": "Triple EMA三层均线策略", "type": "趋势跟踪", "fp": "b5f7b315", "score": 0, "ret": 6.99, "sharpe": -0.22, "dd": 44.84, "pf": 0.81, "wr": 26.8, "trades": 3.3, "pass": False, "reason": "回撤>25%; 年化<15%; 夏普<0.5"},
    {"name": "VWAP趋势跟踪策略", "type": "趋势跟踪", "fp": "5046ba27", "score": 0, "ret": -3.85, "sharpe": -0.14, "dd": 52.82, "pf": 0.84, "wr": 31.8, "trades": 14.5, "pass": False, "reason": "回撤>25%; 年化<15%; 夏普<0.5"},
    {"name": "RSI趋势确认策略", "type": "趋势跟踪", "fp": "239cb63e", "score": 0, "ret": -1.95, "sharpe": -0.18, "dd": 50.29, "pf": 0.93, "wr": 28.7, "trades": 11.1, "pass": False, "reason": "回撤>25%; 年化<15%; 夏普<0.5"},
]

# ==================== 排行榜数据 ====================
top5 = [
    {"rank": 1, "name": "RSI回调买入策略(牛市专用)", "market": "HK", "type": "均值回归", "score": 31.62, "ret": 0.03, "sharpe": 0.09, "dd": 0.04, "pf": 10.0, "wr": 20.0, "trades": 0.1, "params": "period=50, rsi_period=14", "stress": "压力期年化0%/回撤0%", "desc": "在确认的牛市趋势中买回调，RSI从超卖区回升时入场"},
    {"rank": 2, "name": "MACD金叉+趋势确认策略", "market": "HK", "type": "趋势跟踪", "score": 25.80, "ret": 1.97, "sharpe": 0.20, "dd": 22.31, "pf": 1.55, "wr": 41.1, "trades": 3.8, "params": "macd_fast=12, macd_slow=26, macd_signal=9", "stress": "压力期年化0%/回撤0%", "desc": "MACD柱状图从负转正+价格在长期EMA上方"},
    {"rank": 3, "name": "Dual Momentum双动量策略", "market": "US", "type": "趋势跟踪", "score": 19.93, "ret": 1.18, "sharpe": 0.01, "dd": 21.82, "pf": 1.35, "wr": 37.4, "trades": 6.0, "params": "lookback=12M绝对动量+1M相对动量", "stress": "压力期年化0%/回撤0%", "desc": "绝对动量+相对动量月度轮动策略"},
    {"rank": 4, "name": "MACD金叉+趋势确认策略", "market": "US", "type": "趋势跟踪", "score": 15.66, "ret": -0.75, "sharpe": -0.14, "dd": 21.65, "pf": 1.02, "wr": 36.7, "trades": 5.3, "params": "macd_fast=12, macd_slow=26, macd_signal=9", "stress": "压力期年化0%/回撤0%", "desc": "MACD柱状图从负转正+价格在长期EMA上方"},
    {"rank": 5, "name": "RSI回调买入策略(牛市专用)", "market": "US", "type": "均值回归", "score": 10.00, "ret": -0.09, "sharpe": -0.05, "dd": 0.44, "pf": 0, "wr": 0, "trades": 0, "params": "period=50, rsi_period=14", "stress": "压力期年化0%/回撤0%", "desc": "在确认的牛市趋势中买回调，RSI从超卖区回升时入场"},
]
...
def build_top5_detail():
    ...
    for i, s in enumerate(top5):
        market_flag = '🇭🇰' if s['market'] == 'HK' else '🇺🇸'
        cards += f'''
        <div style="border:2px solid {rank_colors[i]};border-radius:10px;margin-bottom:15px;overflow:hidden;">
            <div style="background:{rank_colors[i]}20;padding:12px 20px;display:flex;align-items:center;justify-content:space-between;">
                <span style="font-size:18px;">{rank_icons[i]} 第{s['rank']}名: {s['name']} {market_flag} ({s['market']})</span>
                <span style="font-size:22px;font-weight:bold;color:{rank_colors[i]};">{s['score']:.2f}分</span>
            </div>
            <div style="padding:15px 20px;">
                <div style="display:flex;flex-wrap:wrap;gap:10px;margin-bottom:12px;">
                    <div style="flex:1;min-width:120px;background:#f8f9fa;border-radius:6px;padding:8px 12px;">
                        ...
                        <div style="font-size:18px;font-weight:bold;color:{return_color(s['ret'])};">{s['ret']:.2f}%</div>
                    </div>
                    <div style="flex:1;min-width:120px;background:#f8f9fa;border-radius:6px;padding:8px 12px;">
                        <div style="font-size:11px;color:#888;">夏普比率</div>
                        <div style="font-size:18px;font-weight:bold;">{s['sharpe']:.2f}</div>
                    </div>
                    <div style="flex:1;min-width:120px;background:#f8f9fa;border-radius:6px;padding:8px 12px;">
                        <div style="font-size:11px;color:#888;">最大回撤</div>
                        <div style="font-size:18px;font-weight:bold;color:{dd_color(s['dd'])};">{s['dd']:.2f}%</div>
                    </div>
                    <div style="flex:1;min-width:120px;background:#f8f9fa;border-radius:6px;padding:8px 12px;">
                        <div style="font-size:11px;color:#888;">盈亏比</div>
                        <div style="font-size:18px;font-weight:bold;">{s['pf']:.2f}</div>
                    </div>
                    <div style="flex:1;min-width:120px;background:#f8f9fa;border-radius:6px;padding:8px 12px;">
                        <div style="font-size:11px;color:#888;">胜率</div>
                        <div style="font-size:18px;font-weight:bold;">{s['wr']:.1f}%</div>
                    </div>
                    <div style="flex:1;min-width:120px;background:#f8f9fa;border-radius:6px;padding:8px 12px;">
                        <div style="font-size:11px;color:#888;">年交易次数</div>
                        <div style="font-size:18px;font-weight:bold;">{s['trades']:.1f}</div>
                    </div>
                </div>
                <div style="display:flex;gap:15px;font-size:13px;color:#555;">
                    <div><b>策略类型:</b> {s['type']}</div>
                    <div><b>策略参数:</b> {s['params']}</div>
                </div>
                <div style="display:flex;gap:15px;font-size:13px;color:#555;margin-top:6px;">
                    <div><b>压力测试:</b> {s['stress']}</div>
                </div>
                <div style="font-size:13px;color:#777;margin-top:6px;"><b>描述:</b> {s['desc']}</div>
            </div>
        </div>'''
...
# ==================== 构建废弃策略表格 ====================
def build_rejected_table(strategies, market_label, max_display=10):
    # 按废弃时间降序排列（最近的在前），只展示最近max_display个
    sorted_strategies = sorted(strategies, key=lambda x: x.get('rejected_time', ''), reverse=True)
    display_strategies = sorted_strategies[:max_display]
    rows = ''
    for i, s in enumerate(display_strategies, 1):
    ...
    extra_note = f'<p style="color:#888;font-size:11px;">共{total}个废弃策略，仅展示最近{max_display}个</p>' if total > max_display else ''
    
    return f'''
    <h3 style="color:#2c3e50;">🗑️ {market_label} 废弃策略 ({len(strategies)}个，展示最近{max_display}个)</h3>
    <div style="overflow-x:auto;">
...
<div style="display:flex;flex-wrap:wrap;padding:20px;gap:12px;">
    ...
    <div style="flex:1;min-width:140px;background:#fff3e0;border-radius:8px;padding:15px;text-align:center;">
        <div style="font-size:28px;font-weight:bold;color:#e67e22;">11+11</div>
    ...
    <div style="flex:1;min-width:140px;background:#e8f5e9;border-radius:8px;padding:15px;text-align:center;">
        <div style="font-size:28px;font-weight:bold;color:#27ae60;">11+11</div>
...
<div style="padding:0 20px 10px;">
    <div style="background:#e3f2fd;border-left:4px solid #1976d2;padding:12px 15px;border-radius:0 8px 8px 0;">
        <b>🇺🇸 美股扫描:</b> 发现13 → 去重后11 → 回测11 → 有评分2(得分>0) / 零分9(回撤>25%)
...
<div style="padding:0 20px 20px;">
    <div style="background:#f0f4f8;border:1px solid #d1d5db;border-radius:8px;padding:15px;">
        <h3 style="margin:0 0 10px;color:#2c3e50;font-size:16px;">📋 策略去重规则</h3>
        <div style="font-size:13px;color:#555;line-height:1.8;">
            <div style="margin-bottom:12px;">
                <b style="color:#1976d2;">1. 指纹+市场联合去重</b><br>
                <span style="color:#666;">同一策略指纹(SHA256)在同一市场(US/HK/CN)只保留得分最高者；同一策略可在不同市场分别入榜</span>
            </div>
            <div style="margin-bottom:12px;">
                <b style="color:#1976d2;">2. 实质策略分组去重</b><br>
                <span style="color:#666;">按策略类型+回看期+资产组合分组，每组只保留综合得分最高的1个变体</span>
            </div>
            <div style="margin-bottom:12px;">
                <b style="color:#1976d2;">3. 过拟合风险过滤</b><br>
                <span style="color:#666;">过拟合风险&gt;0.7的变体直接淘汰，即使得分最高也不保留</span>
            </div>
            <div style="margin-bottom:0;">
                <b style="color:#1976d2;">4. 家族检测</b><br>
                <span style="color:#666;">指纹相似度≥90%且参数差异≤10%的策略视为同一家族，保留得分最高者</span>
            </div>
        </div>
    </div>
</div>
...
<div style="padding:0 20px 20px;">
    <h2 style="color:#2c3e50;border-bottom:2px solid #7f8c8d;padding-bottom:8px;">
        🗑️ 废弃策略库 (累计{len(all_rejected)}个: 美股{len(us_strategies)} + 港股{len(hk_strategies)}，展示最近10个)
    </h2>
...
<div style="padding:0 20px 20px;">
    <div style="background:#e8f5e9;border-left:4px solid #27ae60;padding:15px;border-radius:0 8px 8px 0;">
        ...
        <ul style="margin:0;padding-left:20px;font-size:13px;color:#555;">
            ...
            <li>美股9/11策略回撤>25%，港股11/11全部回撤>25%</li>
