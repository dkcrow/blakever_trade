"""
拉普拉斯盘中监控 v10 - 完全对齐三马七星排版
复制三马七星的精确布局、字体大小、间距，但改为亮色主题
"""
import pandas as pd
import numpy as np
...
'''
        ...
        <td style="padding:4px 6px;color:#111827">{name}</td>
